...
```{r warning=FALSE}
NBA_rlis_example_data <- NBA_rlis_example_data 
NBA_rlis_biome_example_data <- NBA_rlis_biome_example_data
NBA_rlie_example_data <- NBA_rlie_example_data
NBA_epli2018_example_data <- NBA_epli2018_example_data
NBA_epli2024_example_data <- NBA_epli2024_example_data

# RLIs grouped by Biome
nba_index_plot(
    TYPE = "RLIs",
...
```{r warning=FALSE}
NBA_press_bar_example_data <- NBA_press_bar_example_data
