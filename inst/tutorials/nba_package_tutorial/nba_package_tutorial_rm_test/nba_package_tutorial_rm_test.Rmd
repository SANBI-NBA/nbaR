...
```{r nba_plot_comb, exercise = TRUE, exercise.eval = FALSE}
...
```{r nba_plot_combex4, exercise = TRUE}
...
```{r nba_plot_RLIex4, exercise = TRUE}
...
**Hint:** Use look at the previous example for guidance, and the NBA_example_RLI_data
:::
